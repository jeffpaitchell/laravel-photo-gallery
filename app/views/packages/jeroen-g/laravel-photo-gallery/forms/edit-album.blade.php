...
<!-- Create a form for editing an album.  The 'method' must be 'PUT' 
The form is using 'EditAlbumsController2.php' and its function 'update()'. -->
...
{{ Form::model($album, array('method' => 'PUT', 'route' => array('edit_album2', $album->album_id))) }}
    ...
    <div class="form-group">
        ...
        {{ Form::label('album_application_fireplace', 'Fireplace') }}
